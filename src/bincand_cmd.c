...
usage(void)
{
  fprintf(stderr,"%s","   [-plo plo] [-phi phi] [-rlo rlo] [-rhi rhi] [-psr psrname] [-candnum candnum] [-candfile candfile] [-usr] [-pb pb] [-x asinic] [-e e] [-To To] [-w w] [-wdot wdot] [-mak] [--] infile\n");
  fprintf(stderr,"%s","      Generates a set of fake orbits and their Fourier modulation spectra for a binary candidate (usually generated by search_bin).  It tries to return the optimum fit for the binary candidate.\n");
  fprintf(stderr,"%s","         -plo: The low pulsar period to check (s)\n");
  fprintf(stderr,"%s","               1 double value between 0 and oo\n");
  fprintf(stderr,"%s","         -phi: The high pulsar period to check (s)\n");
  fprintf(stderr,"%s","               1 double value between 0 and oo\n");
  fprintf(stderr,"%s","         -rlo: The low Fourier frequency bin to check\n");
  fprintf(stderr,"%s","               1 double value between 0 and oo\n");
  fprintf(stderr,"%s","         -rhi: The high Fourier frequency bin to check\n");
  fprintf(stderr,"%s","               1 double value between 0 and oo\n");
  fprintf(stderr,"%s","         -psr: Name of pulsar to check for (do not include J or B)\n");
  fprintf(stderr,"%s","               1 char* value\n");
  fprintf(stderr,"%s","     -candnum: Number of the candidate to optimize from candfile.\n");
  fprintf(stderr,"%s","               1 int value between 1 and oo\n");
  fprintf(stderr,"%s","    -candfile: Name of the bincary candidate file.\n");
  fprintf(stderr,"%s","               1 char* value\n");
  fprintf(stderr,"%s","         -usr: Describe your own binary candidate.  Must include all of the following (assumed) parameters\n");
  ...
  fprintf(stderr,"%s","  version: 05Dec18\n");
  fprintf(stderr,"%s","  ");
  exit(EXIT_FAILURE);
}
/**********************************************************************/
