...
usage(void)
{
  fprintf(stderr,"%s","   [-zap] [-zapfile zapfile] [-in inzapfile] [-out outzapfile] [-baryv baryv] [--] infile\n");
  fprintf(stderr,"%s","      Allows you to interactively or automatically zap interference from an FFT.\n");
  fprintf(stderr,"%s","        -zap: Zap the birds in the FFT from 'zapfile' (write to the FFT file)\n");
  fprintf(stderr,"%s","    -zapfile: A file of freqs and widths to zap from the FFT (when using '-zap')\n");
  fprintf(stderr,"%s","              1 char* value\n");
  fprintf(stderr,"%s","         -in: A file containing a list of freqs (Hz) and the # of harmonics to zap\n");
  fprintf(stderr,"%s","              1 char* value\n");
  fprintf(stderr,"%s","        -out: A file to write that will contain the freqs and widths (Hz) zapped\n");
  fprintf(stderr,"%s","              1 char* value\n");
