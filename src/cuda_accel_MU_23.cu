...
__host__  void mult23_c(dim3 dimGrid, dim3 dimBlock, int i1, cudaStream_t multStream, cuFFdotBatch* batch, cuFfdotStack* cStack)
{
  int offset            = cStack->startIdx;
   ...
   switch (cStack->mulChunk)
   {
    ...
    case 1 :
    {
      mult23_k<FLAGS,noSteps,1,1><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 2 :
    {
      mult23_k<FLAGS,noSteps,1,2><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 3 :
    {
      mult23_k<FLAGS,noSteps,1,3><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 4 :
    {
      mult23_k<FLAGS,noSteps,1,4><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 5 :
    {
      mult23_k<FLAGS,noSteps,1,5><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 6 :
    {
      mult23_k<FLAGS,noSteps,1,6><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 7 :
    {
      mult23_k<FLAGS,noSteps,1,7><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 8 :
    {
      mult23_k<FLAGS,noSteps,1,8><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 9 :
    {
      mult23_k<FLAGS,noSteps,1,9><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 10 :
    {
      mult23_k<FLAGS,noSteps,1,10><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 11 :
    {
      mult23_k<FLAGS,noSteps,1,11><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
    ...
    case 12 :
    {
      mult23_k<FLAGS,noSteps,1,12><<<dimGrid, dimBlock, i1, multStream>>>((fcomplexcu*)cStack->kernels->d_kerData , cStack->d_iData, (fcomplexcu*)cStack->d_planeMult, cStack->width, cStack->strideCmplx, offset);
      break;
    }
#endif
